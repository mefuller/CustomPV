...
P = 100*U.atm; %design pressure
ID = 4*U.in; %internal diameter
...
%Assume that UG-34(p) appropriate if thickness increaded by depth of o-ring groove:
%Then:
C = 0.3; %design parameter from figure UG-34: o-ring seal

%see lab notebook for first guess
hgroove = ORdepth; %o-ring groove depth on each face (half depth on all flanges)

[theadmin] = FlatHeadThickness(C,Ejoint,P,d,S);
theadtotal = theadmin + 0.5*hgroove;
